...
import online_store.entities.impl.DefaultProduct;
...
public class DefaultProductManagementService implements ProductManagementService{
	...
	private static void initProducts() {
		...
		products = Arrays.asList(new DefaultProduct(1, "Hardwood Oak Suffolk Internal Door", "Doors", 109.99),
	...
	public Product getProductById(int productIdToAddToCart) {
		for(Product p: products) {
			if(p!=null && p.getId()== productIdToAddToCart) {
				return p;
			}
		}
		return null;
